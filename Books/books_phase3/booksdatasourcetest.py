...
class BooksDataSourceTest(unittest.TestCase):
    ...
    def test_authors_start_year_correct_results(self): 
        self.assertEqual(self.booksDataSource.authors(start_year = 2015), [{'id':3, 'last_name':'Lewis', 'first_name':'Sinclair', 'birth_year':1885, 'death_year':None}, {'id':2, 'last_name':'Morrison', 'first_name':'Toni', 'birth_year':1931, 'death_year':None}, {'id':24, 'last_name':'Carré', 'first_name':'John Le', 'birth_year':1931, 'death_year':None}, {'id':0, 'last_name':'Willis', 'first_name':'Connie', 'birth_year':1945, 'death_year':None}, {'id':11, 'last_name':'Rushdie', 'first_name':'Salman', 'birth_year':1947, 'death_year':None}, {'id':6, 'last_name':'Pratchett', 'first_name':'Terry', 'birth_year':1948, 'death_year':2015}, {'id':12, 'last_name':'Bujold', 'first_name':'Lois McMaster', 'birth_year':1949, 'death_year':None}, {'id':16, 'last_name':'Murakami', 'first_name':'Haruki', 'birth_year':1949, 'death_year':None}, {'id':5, 'last_name':'Gaiman', 'first_name':'Neil', 'birth_year':1960, 'death_year':None}, {'id':20, 'last_name':'Jemisen', 'first_name':'N.K.', 'birth_year':1972, 'death_year':None}, {'id':18, 'last_name':'Alderman', 'first_name':'Naomi', 'birth_year':1974, 'death_year':None}])
